...
pantalla=document.getElementById("res"); //elemento pantalla de salida
...
function teclado (elEvento) { 
         ...
         k=evento.keyCode || evento.which; //número de código de la tecla.
         ...
         if (k==42 || k==106) {operar('*')} //tecla multiplicación
         if (k==187) {operar('+')} //tecla suma
         if (k==189 || k==109) {operar('-')} //tecla resta
         if (k==111) {operar('/')} //tecla división
         if (k==61 || k==13) {igualar()} //Tecla igual: intro o barra espaciadora
